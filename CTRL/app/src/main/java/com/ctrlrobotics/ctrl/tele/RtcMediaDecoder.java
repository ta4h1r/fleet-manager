 ...
 */
public class RtcMediaDecoder {
    private String TAG = "rtcDecoder：";
    ...
    public void drawVideoSample(ByteBuffer sampleData) {
        try {
            ...
            if (inIndex >= 0) {
                ...
                buffer.flip();
//                Log.i("rtcDecodeActivity", "" + buffer.toString());
//                Log.i(TAG, "showVideo: Get the position of the video pointer！");
    ...
    public void onDecodingError(int index) {
        switch (index) {
    ...
    /**
     * When you encounter the synchronization stream of the media stream, it is the key frame.
     *
     * @param
     */
